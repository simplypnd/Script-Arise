...
-- simple flag stored via WindUI config; we no longer rely on getgenv
...
do
    ...
    sec:Button({
        ...
        Callback = function()
            if not ConfigManager or not AuraConfig or type(AuraConfig.Save) ~= "function" then
                WindUI:Notify({
                    Title   = "Config",
    ...
    sec:Button({
        ...
        Callback = function()
            if not ConfigManager or not AuraConfig or type(AuraConfig.Load) ~= "function" then
                WindUI:Notify({
                    Title   = "Config",
...
pcall(function()
    if ConfigManager and AuraConfig and type(AuraConfig.Load) == "function" then
        AuraConfig:Load()
    end
end)
